...
_generateExpenses() {
  List<Expense> expenses = [
    Expense(name: 'Jajan 0', cost: rand.nextDouble() * 90),
    Expense(name: 'Jajan 1', cost: rand.nextDouble() * 90),
    Expense(name: 'Jajan 2', cost: rand.nextDouble() * 90),
    Expense(name: 'Jajan 3', cost: rand.nextDouble() * 90),
    Expense(name: 'Jajan 4', cost: rand.nextDouble() * 90),
    Expense(name: 'Jajan 5', cost: rand.nextDouble() * 90),
  ];
  return expenses;
}
